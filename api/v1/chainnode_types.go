...
type ChainNodeSpec struct {
	...
	// DeletionPolicy controls whether durable resources generated by Cosmopilot are retained or
	// deleted with this ChainNode. All resource classes default to Retain.
	// +optional
