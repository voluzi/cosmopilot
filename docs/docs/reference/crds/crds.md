...
| resources | Compute resources for the export upload job pod. When unset, the pod requests chunkSize × (concurrentJobs + 1) of memory for GCS, or of ephemeral storage for the S3 part spool. | *corev1.ResourceRequirements | false |
