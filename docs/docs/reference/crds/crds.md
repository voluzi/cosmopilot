...
| cosmosignerStateStorageClassName | CosmosignerStateStorageClassName records the storage class of the managed signer's raft-state PVCs. Empty means the cluster default class. See CosmosignerStateStorageSize. Not meant to be set by hand. | *string | false |
...
| stateStorageClassName | StateStorageClassName records the storage class of this signer's raft-state PVCs. Empty means the cluster default class. See StateStorageSize. | *string | false |
