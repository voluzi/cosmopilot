...
| appImage | Full application image currently deployed, including its repository. Upgrades may move nodes to a different repository, so this is the authoritative record of what is running. | string | false |
